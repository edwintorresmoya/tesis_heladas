...
resumen1 = pd.read_pickle('resumen_simulaciones_200702.pickle')# Son los archivos de la priera extracción
...
recoleccion_minim_1 = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/simulacion_mejor_200702.csv')                                    
...
for j in recoleccion_minim_1.cod_1:#[21201200.0]:#
    ...
    base_series.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/tablas_estaciones_dominios/tablas_series_200702/'+str(j)[:-2]+'.csv')
