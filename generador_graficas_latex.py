...
os.chdir('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/datos_ideam/graficas_nan')
lista_1 = os.listdir()
...
os.chdir('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/comparacion_grafica_otras_var')
lista_1 = os.listdir()
lista_1 = pd.DataFrame({'archi':lista_1})
lista_1['anno_1'] = lista_1.archi.str[0:6]
lista_1['cod'] = lista_1.archi.str[7:15]
lista_1['tipo'] = lista_1.archi.str[15:-4]
