...
#Selección del directorio que contiene el archivo en tr5
...
##Union de las bases con la georreferenciación del IDEAM hay que ser cuidadosos porque la altura de las estaciones no es tan precisa 
os.chdir('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/datos_ideam')
