...
mejores4 = mejores[condi]

resumen = pd.concat([resumen1, mejores4])
...
for j in recoleccion_minim_1.cod_1:#[21201200.0]:#
    ...
    base_series.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/tablas_estaciones_dominios/tablas_series_201508/'+str(j)[:-2]+'.csv')
