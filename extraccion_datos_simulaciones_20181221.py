...
Script usado par ala extracción de los valores de las diferentes simulaciones
@author: edwin
"""
...
resumen = pd.read_pickle('resumen_simulaciones_200702.pickle')
...
for j in resumen_back.cod.unique()[1:]:#[21201200.0]:#
    ...
    recoleccion_minim_1 = recoleccion_minim
###### Esta tabla se va a guardar ya que a partír de esta se corregiran los demás datos.
    recoleccion_minim_1.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/fechas_min_sel_tiemp_simulacion_200702.csv')            
...
tabla_ej2 = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/simulacion_200702_20190114.csv')        
...
f = open('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/salida_latex_simu.csv','w')

with open('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/salida_latex_simu.csv','w') as f:   
