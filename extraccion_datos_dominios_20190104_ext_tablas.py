...
SCript usado para generar las tablas que la profe quiere para hacer la verificación de los valores
@author: edwin
"""
...
resumen2[(resumen2.cod == 21195160.0) & (resumen2.fecha == 'Simulación 1') & (resumen2.date_1.str[0:3] == 'd01')].date_2
...
for j in resumen_back.cod.unique()[1:]:#[21201200.0]:#
    ...
    for count, i in enumerate(resumen_back.fecha.unique()[1:]):
        ...
        #pdb.set_trace()
        for count_2, kk in enumerate(['d01','d02','d03']):
            print(kk)
    ...
    base_series.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/tablas_estaciones_dominios/tablas_series/'+str(j)[:-2]+'.csv')
#            #desvest_const = tmp_real[(tmp_real.date > comparacion.date.min()) & (tmp_real.date < comparacion.date.max())].tmp_2m.std() # Saca la desviación estándar de los valores de las estaciones automáticas a partir de los días
#            
#            desvest_const = tmp_real[(tmp_real.date > comparacion.date.min()) & (tmp_real.date < comparacion.date.max())] # Saca la desviación estándar de los valores de las estaciones automáticas a partir de los días
#            
...
##recep_t.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/ta_rasumen_ejem_20181124_con_correccion_2_tabla.csv')        
#
#recep_t = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/ta_rasumen_ejem_20181124_con_correccion_2_tabla.csv')
#
#
