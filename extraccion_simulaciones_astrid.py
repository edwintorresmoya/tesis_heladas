...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 16 15:00:33 2019
Scrip creado para hacer los análisis de las extracciones propuestas por la profe Astrid
Este es va a usar para hacer la extracción de todos los archivos.
@author: edwin
"""
...
for fecha_1 in ['200702', '201408', '201508', '201509']:
    #fecha_1 = '200702'
    #pdb.set_trace()
    resumen1 = pd.read_pickle('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/extraccion_tiempo_20190214_1.pickle') # este esl archivo de los datos de las nuevas simulacioens de la profe
    condi = resumen1.fecha.str.contains(fecha_1)
    condi[0] = False
    mejores2 = resumen1[condi]
    ...
    recep_t = pd.DataFrame({'tipo_1':np.tile(resumen_back.fecha.unique(), 93),
                                ...
                                'cod_1':np.repeat((resumen_1.cod.unique()[1:]).astype(np.str), (len(resumen_back.fecha.unique()) * 3))
                                })
    ...
    ###### Esta tabla se va a guardar ya que a partír de esta se corregiran los demás datos.
        recoleccion_minim_1.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/astrid_mejor_'+fecha_1+'.csv')                    
    ...
    recep_t.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/simulacion_mejor_astrid_'+fecha_1+'.csv')        
    
    recep_t = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/simulacion_mejor_astrid_'+fecha_1+'.csv')        
    ...
    tabla_ej2.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/simulacion_'+fecha_1+'_astrid.csv')        
