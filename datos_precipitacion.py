...
#
os.chdir('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/datos_ideam/validados_col_col/')
base_validada = pd.read_csv('v_21206990_vel_vi10.csv')
base_validada_tmp = base_validada[base_validada.val_vv == 0]
base_validada_tmp.date =  pd.to_datetime(base_validada_tmp.date, format ='%Y%m%d %H:%M:%S', errors='coerce')
...
plt.rcParams["figure.figsize"] = (8,8)
plt.plot_date(base_validada_2.date, base_validada_2.vel_vi10, '-',color = 'gray')
plt.axhline(2, color = 'k', linestyle = ':') #-4.7
plt.xlabel('Fecha - Hora')
plt.ylabel('m/s')
plt.xticks(rotation=90)

plt.savefig('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/casos_altas_bajas/grafica_minimas_vv_tibaitata_helada.png' ,dpi = 100)
plt.close()
...
plt.savefig('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/casos_altas_bajas/grafica_minimas_vv_tibaitata_helada_2014.png' ,dpi = 100)
plt.close()
...
plt.savefig('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/casos_altas_bajas/grafica_minimas_vv_tibaitata_helada_201509.png' ,dpi = 100)
plt.close()
...
plt.savefig('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/casos_altas_bajas/grafica_minimas_vv_tibaitata_helada_201508.png' ,dpi = 100)
plt.close()
