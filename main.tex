...
\include{tercer}
\include{cuarto}
\include{quinto_final}

%

\include{anexo_final} % No hace parte de ningún informe es casi un capítulo
%\include{anexoestaciones_autom_y_conv_usadas} % primer Segundo
%\include{anexogra_mensual_eventos_sb} % Segundo pero tiene problemas porque %son %muchos archivos
%\include{anexoresumen_control_calidad_est_con2} % Segundo
%\include{anexoseries_tiempo_temperatura} % Tercero
%\textit{
%\include{anexonamelist-input-wps} % Tercero
%}
%\include{anexoresultado_comparaciones_entre_estadisticos} % Tercero
%\include{anexodiagramas_taylor_div_estaciones} % Tercero
%
%\include{anexocorreccion_altura} % Tercero
%\include{anexodiag_taylor_estaciones_aut_val} % Tercero
%\texttt{
%\include{anexonamelist_mejor_parametrizacion} % Cuarto
%}
%\include{anexoresultados_comparaciones_estadisticos_tiempos} % Cuarto
%\include{anexograficas_taylor_tiempos_4casos} % Cuarto
%
%
%\include{anexograficas_temperatura} %%Quinto
%\include{anexograficas_otras_variables_wrf} %%Quinto
...
%\include{anexograficas_taylor_200702} % Gráficas de todas las estaciones
%\include{anexograficas_dea5} % gráficas hechas para la profe Astrid
%\include{anexo_casos_total} % Graficas de todos los diagramas de Taylor 
%\include{anexo_graficas_series_vs_referencia} % Anexo de las graficas de todas las simulaciones vs la temperatura de referencia
