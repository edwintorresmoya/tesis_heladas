...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 20 18:15:40 2019
Extración datos tiempo para el 201408
@author: edwin
"""
...
resumen = pd.read_pickle('ext_otros_tiempos2.pickle')# Extracción de los datos de la simulación 2, 3, 4 para la configuración icm_3
resumen2 = resumen[~resumen.fecha.isnull()]

##########
#resumen = pd.read_pickle('ext_tiempo_imc3_20190517.pickle')# Extracción de los datos de la simulación 2, 3, 4 para la configuración icm_3
#resumen1 = pd.read_pickle('ext_otros_tiempos2_1.pickle')# Extracción de los datos de las simulaciones 2, 3, 4 para la configuración icm
#resumen2 = pd.concat([resumen, resumen1])
...
#        estaciones_aut = pd.concat([estaciones_aut, estaciones_aut_1])
        ...
        for kk in ['d01']:
            ...
            desvest_const_1 = comparacion.tmp_2m.std() # Saca la desviación estándar de los valores de las estaciones automáticas a partir de los días
...
recoleccion_minim_1.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/simulacion_201408.csv')                    

recoleccion_minim_1 = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/simulacion_201408.csv')                                    
...
#a_b1 =  pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/tiempo_200702.csv')                    
...
for j in resumen_back.cod.unique():#[21201200.0]:#
    #print(j)
    min_2 = []
    max_2 = []
...
recep_t.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/tiempo_201408.csv')        

recep_t = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/tiempo_201408.csv')        
