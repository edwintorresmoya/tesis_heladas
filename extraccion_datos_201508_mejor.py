...
#resumen1 = pd.read_pickle('resumen_simulaciones_201508.pickle')
#mejores = pd.read_pickle('ext_mejores.pickle')
#condi = mejores.fecha.str.contains('201508')
#condi[0] = False
#mejores2 = mejores[condi]
#
#resumen = pd.concat([resumen1, mejores2])

resumen1 = pd.read_pickle('resumen_simulaciones_201508.pickle')# Son los archivos de la priera extracción
mejores = pd.read_pickle('extraccion_icm_con_nmrse.pickle') # En esta línea van los valores con la corrección con NRMSE
#mejores1 = pd.read_pickle('ext_mejores_2.pickle') # En este están los llamados mejores
...
#mejores = pd.concat([mejores1, mejores2, mejores3])
condi = mejores.fecha.str.contains('201508')
condi[0] = False
mejores2 = mejores[condi]
...
#fecha de int es 2015080410 Pero sumando 5 horas es igual a 20017020460 <- esta es la hora que se usa en WRF
...
###### Esta tabla se va a guardar ya que a partír de esta se corregiran los demás datos.
    recoleccion_minim_1.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/simulacion_mejor_201508.csv')                    

recoleccion_minim_1 = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/simulacion_mejor_201508.csv')                                    
...
############                    # Realizado con la finalidad de hacer las gráficas de la comparación entre las estaciones
#            plt.plot_date(comparacion.date, comparacion.tmp_2m)
#            plt.plot_date(comparacion.date, comparacion.T2)
#            plt.legend()
#            plt.xlabel('Fecha - Hora')
#            plt.ylabel('Temperatura °C')
#            plt.xticks(rotation=90)
#            plt.vlines(x=[ fecha_inicio, fecha_fin], ymin=base_val.tmp_2m.min(), ymax=base_val.tmp_2m.max(), linestyle = ':', color = 'black' )
#            plt.savefig('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/comparacion/201508'+str(j)+str(i)+str(kk)+'.png' ,dpi = 100)
#            plt.close()
            #desvest_const = tmp_real[(tmp_real.date > comparacion.date.min()) & (tmp_real.date < comparacion.date.max())].tmp_2m.std() # Saca la desviación estándar de los valores de las estaciones automáticas a partir de los días
...
recep_t.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/simulacion_mejor_201508.csv')        
...
tabla_ej2.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/simulacion_201508_20190114.csv')        
...
f = open('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/salida_latex_201508.csv','w')

with open('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/salida_201508.csv','w') as f:##Usado para crear un archivo que reciba todas los comandos y se guarden en una hoja
