...
resumen = pd.read_pickle('resumen_simulaciones_201408.pickle')
...
#recep_t.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/simulacion_201408.csv')        
...
tabla_ej2.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/simulacion_201408_20190114.csv')        
...
f = open('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/salida_latex_201408.csv','w')

with open('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/salida_201408.csv','w') as f:##Usado para crear un archivo que reciba todas los comandos y se guarden en una hoja
