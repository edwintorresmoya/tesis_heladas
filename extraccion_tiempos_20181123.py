...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 23 09:47:29 2018
Extracción de los datos de altura con corrección para el 20181123
@author: edwin
"""
...
resumen = pd.read_pickle('resumen_distancia_20181008.pickle')
...
#    recoleccion_minim_1.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/distancias_min_20181123.csv.csv')                    
#    recoleccion_minim_1 = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/distancias_min_20181123.csv.csv')                    
...
for j in resumen_back.cod.unique()[1:]:#[21201200.0]:#
    ...
    recoleccion_minim_1 = recoleccion_minim
###### Esta tabla se va a guardar ya que a partír de esta se corregiran los demás datos.
    recoleccion_minim_1.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/dist_min_sel_dom.csv')            
...
recep_t.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/distancia_20181123_con_correccion.csv')        
...
tabla_ej2.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/tabla_final_distancia_20181123.csv')        

tabla_ej1.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/tabla_final_distancia_20181123_2.csv')        
...
estaciones_aut.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/resumenestaciones_aut_dist.csv')
estaciones_aut = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/resumenestaciones_aut_dist.csv')
