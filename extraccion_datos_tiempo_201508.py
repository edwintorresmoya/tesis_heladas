...
Extración datos tiempo para el 201508
@author: edwin
"""
...
condi = resumen2.fecha.str.contains('201508')
...
recep_t.to_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/tiempo_201508.csv')        

recep_t = pd.read_csv('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/Extraccion_dominios/tiempo_201508.csv')        
...
with open('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/salida_latex_dominios_caso3.csv','w') as f:   
