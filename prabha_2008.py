...
#        base = base[[col for col in base.columns if '35085080' not in col]] # Usado para sacar las columnas de La Capilla
...
#        #### Función creada para sacar los valores de la lista que están dentro de los códigos
#        lista_vacia_1 = []
#        lista_vacia_2 = []
#        base_nombres = pd.DataFrame({'n_col':base_otras.columns, 'ix_1':np.arange(len(base_otras.columns))})
#        for n_1, ix_1 in zip(base_nombres.n_col, base_nombres.ix_1):
#            len1 = len(lista_vacia_1)
#            for cod_ix in ['35075080', '35025090', '21205791','35075070','21206950', '21206790', '35025080', '21206940', '35035130']:
#                if n_1[0:8] == cod_ix:
#                    lista_vacia_1.append(ix_1)
#            if len1 == len(lista_vacia_1):
#                lista_vacia_2.append(ix_1)
#
#        base_otras1 = base_otras.iloc[:,lista_vacia_1]
#        base_otras2 = base_otras.iloc[:,lista_vacia_2]
#
...
#        base_otras_d01_mean = base_otras1[base_otras1.columns[~base_otras1.columns.str.contains('d01')].tolist()].mean(axis=1)
#        base_otras_d02_mean = base_otras1[base_otras1.columns[~base_otras1.columns.str.contains('d02')].tolist()].mean(axis=1)
#        base_otras_d01_mean1 = base_otras2[base_otras2.columns[~base_otras2.columns.str.contains('d01')].tolist()].mean(axis=1)
#        base_otras_d02_mean1 = base_otras2[base_otras2.columns[~base_otras2.columns.str.contains('d02')].tolist()].mean(axis=1)
#        print(base_otras[base_otras.columns[~base_otras.columns.str.contains('d02')].tolist()].mean())
#
#        ww = base.hora.copy()
#        for iii in base.hora:
#            ww[iii] = 5
...
#        base_otras_d01_std = base_otras1[base_otras1.columns[~base_otras1.columns.str.contains('d01')].tolist()].std(axis=1)
#        ### Estos condicionales fueron puestos para sd5
#        if base_otras_d01_std.sum() ==0:
#            base_otras_d01_std = ww
#        base_otras_d02_std = base_otras1[base_otras1.columns[~base_otras1.columns.str.contains('d02')].tolist()].std(axis=1)
#        if base_otras_d02_std.sum() ==0:
#            base_otras_d02_std = ww
#
#        base_otras_d01_std1 = base_otras2[base_otras2.columns[~base_otras2.columns.str.contains('d01')].tolist()].std(axis=1)
#        if base_otras_d01_std1.sum() ==0:
#            base_otras_d01_std1 = ww
#        base_otras_d02_std1 = base_otras2[base_otras2.columns[~base_otras2.columns.str.contains('d02')].tolist()].std(axis=1)
#        if base_otras_d02_std1.sum() ==0:
#            base_otras_d02_std1 = ww
#
#        base_2 = pd.concat([base.hora, base_ideam_i1, base_ideam_i2, base_ideam_c1, base_ideam_c2, base_ideam_31, base_ideam_32, base_otras_d01_mean, base_otras_d02_mean, base_otras_d01_std, base_otras_d02_std, base_otras_d01_mean1, base_otras_d02_mean1, base_otras_d01_std1, base_otras_d02_std1], axis=1)
#
#        base_2.columns.values[1:] = ['ideam_i1', 'ideam_i2', 'ideam_c1', 'ideam_c2', 'ideam_31', 'ideam_32', 'otras_d01_mean', 'otras_d02_mean', 'otras_d01_std', 'otras_d02_std','otras2_d01_mean', 'otras2_d02_mean', 'otras2_d01_std', 'otras2_d02_std']
#
...
#        
#        
#        ax1.errorbar(base_2.ix_1, base_2.otras_d01_mean, yerr=base_2.otras_d01_std, linestyle='-', label = 'GE-1 d01', marker = 's', color = 'forestgreen')
#        ax1.errorbar(base_2.ix_1, base_2.otras_d02_mean, yerr=base_2.otras_d02_std, linestyle='-', label = 'GE-1 d02', marker = '^', color = 'forestgreen')
#        ax1.errorbar(base_2.ix_1, base_2.otras2_d01_mean, yerr=base_2.otras2_d01_std, linestyle='-', label = 'GE-2 d01', marker = 's', color = 'darkred')
#        ax1.errorbar(base_2.ix_1, base_2.otras2_d02_mean, yerr=base_2.otras2_d02_std, linestyle='-', label = 'GE-2 d02', marker = '^', color = 'darkred')
#
...
#            ax1.errorbar(base_2.ix_1, base_2.ideam_31, linestyle='-', label =  'La Boyera icm-mp_physics 3 d01', marker = 's', color = 'b')
#            ax1.errorbar(base_2.ix_1, base_2.ideam_32, linestyle='-', label =  'La Boyera icm-mp_physics 3 d02', marker = '^', color = 'b')
...
#            ax1.errorbar(base_2.ix_1, base_2.ideam_31, linestyle='-', label = 'Tibaitatá icm-mp_phyics 3 d01', marker = 's', color = 'b')
#            ax1.errorbar(base_2.ix_1, base_2.ideam_32, linestyle='-', label = 'Tibaitatá icm-mp_phyics 3 d02', marker = '^', color = 'b')
...
def fx_d(observaciones, modelo):
    ...
    return(round(d1, 2), round(acc_0, 2), round(acc_25, 2), round(mbe, 2), round(mae, 2), round(rmse, 2), round(pearson, 2))
...
def table3():
    ...
    for i, j in zip(['200702','201509'],['201408','201509']):
    #for i in ['201508','201509']:
        adicionar = pd.DataFrame({'year':[],'id':[], 'd1':[], 'acc_0':[], 'acc_25':[], 'mbe':[], 'mae':[], 'rmse':[], 'pearson':[]})
        os.chdir('/media/edwin/6F71AD994355D30E/Edwin/Maestría Meteorologia/Tesis/tablas_estaciones_dominios/tablas_series_'+i)
        lista_archivos2 = pd.DataFrame({'col_1':os.listdir()})
...
### se debe correr con el tiempo 18 , 22 , con max() y min()
